...
python pipeline.py --run >> logs\daily_run.log 2>&1
...
python analyze_existing.py --auto >> logs\daily_run.log 2>&1
...
python data_clean.py >> logs\daily_run.log 2>&1
...
python prepare_final_data.py >> logs\daily_run.log 2>&1
